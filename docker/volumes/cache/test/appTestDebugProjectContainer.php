...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api.company_normalizer' => 'getApi_CompanyNormalizerService',
            'api.pack_strategy' => 'getApi_PackStrategyService',
            'api.package_factory' => 'getApi_PackageFactoryService',
            'api.product_handler' => 'getApi_ProductHandlerService',
    ...
    /**
     * Gets the public 'api.company_normalizer' shared service.
     *
     * @return \ApiBundle\Service\Normalize\CompanyNormalizer
     */
    protected function getApi_CompanyNormalizerService()
    {
        return $this->services['api.company_normalizer'] = new \ApiBundle\Service\Normalize\CompanyNormalizer();
    }

    /**
     * Gets the public 'api.pack_strategy' shared service.
     *
     * @return \ApiBundle\Service\Strategy\PackStrategy
     */
    protected function getApi_PackStrategyService()
    {
        return $this->services['api.pack_strategy'] = new \ApiBundle\Service\Strategy\PackStrategy();
    }

    /**
     * Gets the public 'api.package_factory' shared service.
     *
     * @return \ApiBundle\Service\Factory\PackageFactory
     */
    protected function getApi_PackageFactoryService()
    {
        return $this->services['api.package_factory'] = new \ApiBundle\Service\Factory\PackageFactory();
    }

    /**
     * Gets the public 'api.product_handler' shared service.
     *
     * @return \ApiBundle\Service\Request\ProductHandler
     */
    protected function getApi_ProductHandlerService()
    {
        return $this->services['api.product_handler'] = new \ApiBundle\Service\Request\ProductHandler();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('wTbSqa6Q42', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('M0tV-HyhVv', 0, 'ILrv9Whg5QioxZbXjDheyy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, ${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ValidatorCacheWarmer($this->get('validator.builder'), (__DIR__.'/validation.php'), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2VqDOdpChL', 0, 'ILrv9Whg5QioxZbXjDheyy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE))), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'}), 6 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\SerializerCacheWarmer(array(0 => new \Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader($this->get('annotation_reader'))), (__DIR__.'/serialization.php'), ${($_ = isset($this->services['cache.serializer']) ? $this->services['cache.serializer'] : $this->getCache_SerializerService()) && false ?: '_'}), 7 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 8 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this, new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array())), 9 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'database', 'port' => NULL, 'dbname' => 'packer', 'user' => 'packer', 'password' => 'packer', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_54188f460aac2bb328456cd1820b286040c9bc90983d964d388b3ae8273c040c');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('174f101cb504806b86464610e4bd2fcfb5946708');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tfCBTmT5WB', 0, 'ILrv9Whg5QioxZbXjDheyy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('m-eVmzNL5g', 0, 'ILrv9Whg5QioxZbXjDheyy', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5bb9dbea044616.20007936')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'session.save_path': $value = ($this->targetDirs[3].'/app/../var/sessions/test'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => NULL,
            'database_name' => 'packer',
            'database_user' => 'packer',
            'database_password' => 'packer',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '174f101cb504806b86464610e4bd2fcfb5946708',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '174f101cb504806b86464610e4bd2fcfb5946708',
